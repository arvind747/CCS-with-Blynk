 ...
 *      Author: Arvind-Infiquity
 */


#ifndef BLYNKHANDLERS_H_
#define BLYNKHANDLERS_H_
...
//typedef void (*WidgetReadHandler)(BlynkReq& request);                                //Its already declare in blynk.h
...
WidgetReadHandler GetReadHandler(uint8_t pin);                      //Its already declare in blynk.h
